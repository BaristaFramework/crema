...
import { ProgressChart as BlockChart } from '@baristaframework/crema';
  ...
  render() {
    return (
      <Fragment>
        ...
        <div className="chartWrapper">
          <BlockChart items={TEST} valueKey="value" labelPosition="below" totalValue={100 * 10000} hideOutline={true} />
        </div>
